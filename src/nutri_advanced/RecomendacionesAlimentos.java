 ...
 * @author yordyg
 */
public class RecomendacionesAlimentos 
{
    public static ArrayList Receta(float ReqerimientoCalorico)
    {
//        ReqerimientoCalorico=(float)(ReqerimientoCalorico*.80);
    ...
    {
       ArrayList Receta1=Receta((float) 1909.02);
       
        System.out.println("Numero De Alimentos:"+Receta1.size());
        for (int i = 0; i < Receta1.size(); i++) {
            System.out.println(Receta1.get(i));
        }
