 ...
 * @author Alexis Lopez
 */
public class Loging_App_Nutri_Advanced extends javax.swing.JFrame {

        private Conexion conexion = null; 
	private ResultSet rs = null;
        public String nom;
    
    public Loging_App_Nutri_Advanced() 
    {
    ...
    private void initComponents() {
        ...
        jLabel_title.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icono-nutrición.jpeg"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/locked.png"))); // NOI18N
        jLabel3.setText("jLabel3");

        jButton1.setBackground(new java.awt.Color(255, 255, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/arrow-up.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel_usuario, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 264, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sent = "Select * from Usuarios where Usuario = '"+user+"' and Contraseña = '"+pass+"'";
        
        rs = conexion.Consultar(sent);
        ...
        try
        {
            if(rs.next())
            {
                ...
                dispose();
                nom = new String();
                nom = "Select Nombre from Usuarios where Usuario = '"+user+"' and Contraseña = '"+pass+"'";
                String  valor ;
                valor = user;
                pp.Buscar(valor);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Loging_App_Nutri_Advanced.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Loging_App_Nutri_Advanced().setVisible(true);
